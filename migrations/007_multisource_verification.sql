-- ============================================================
-- 007 — Multi-source verification (OSM + Wikidata + Census)
-- Run in the Supabase SQL Editor. Safe to re-run. Supersedes 006.
--
-- 141 buildings confirmed BY NAME by an authoritative source
--   OSM: 136   Wikidata: 5
-- 59 pins relocated to the matched feature; 5 floor counts from OSM.
...
update buildings set verified = true where id in (
  3, 4, 6, 8, 9, 13, 14, 15, 16, 17, 20, 21, 22, 23, 25,
  26, 28, 29, 31, 32, 33, 34, 35, 36, 37, 38, 39, 41, 42, 43,
  44, 46, 51, 59, 63, 74, 75, 76, 77, 78, 88, 90, 91, 95, 96,
  97, 98, 99, 100, 101, 102, 109, 112, 113, 124, 125, 127, 128, 129, 130,
  131, 141, 151, 169, 177, 196, 197, 203, 207, 208, 209, 210, 211, 212, 214,
  218, 219, 220, 224, 225, 228, 234, 244, 247, 248, 251, 253, 254, 255, 256,
  257, 259, 262, 263, 264, 269, 302, 305, 360, 362, 372, 375, 377, 383, 384,
  392, 404, 409, 432, 436, 437, 438, 439, 442, 443, 444, 447, 448, 452, 455,
  457, 483, 511, 512, 537, 541, 542, 561, 574, 575, 581, 583, 584, 587, 590,
  591, 594, 597, 599, 601, 602
);
